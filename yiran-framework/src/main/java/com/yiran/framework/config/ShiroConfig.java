...
import com.yiran.framework.shiro.realm.UserRealm;
import com.yiran.framework.shiro.session.OnlineSessionDAO;
import com.yiran.framework.shiro.session.OnlineSessionFactory;
import com.yiran.framework.shiro.web.filter.LogoutFilter;
import com.yiran.framework.shiro.web.filter.captcha.CaptchaValidateFilter;
import com.yiran.framework.shiro.web.filter.online.OnlineSessionFilter;
import com.yiran.framework.shiro.web.filter.sync.SyncOnlineSessionFilter;
import com.yiran.framework.shiro.web.session.OnlineWebSessionManager;
import com.yiran.framework.shiro.web.session.SpringSessionValidationScheduler;
...
public class ShiroConfig
{
    ...
    {
        net.sf.ehcache.CacheManager cacheManager = net.sf.ehcache.CacheManager.getCacheManager("yiran");
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager)
    {
        ...
        filterChainDefinitionMap.put("/yiran/**", "anon");
        filterChainDefinitionMap.put("/druid/**", "anon");
        filterChainDefinitionMap.put("/captcha/captchaImage**", "anon");
        filterChainDefinitionMap.put("/Bootstrapfileinput/**", "anon");
