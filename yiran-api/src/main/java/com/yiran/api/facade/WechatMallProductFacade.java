...
//		map.put("recommendList", recommendList);
	...
	public ResultWrapper<Map<String,Object>> saveShopCat(
		...
		if(shopCat !=null){
			...
			wechatShoppingCart.setUserId("oAv2w07K6_YrG4nW9qvEGMy2ydY8");
			WeixinUser weixinUser = weixinUserService.selectWeixinUserByOpenId("oAv2w07K6_YrG4nW9qvEGMy2ydY8");
    ...
    @ApiOperation(value = "查询产品详情信息",notes="查询产品详情信息")
	public ResultWrapper<Map<String,Object>> queryGoodsDetail(@ApiParam(required = true, name = "productId", value = "产品ID") @PathVariable Integer productId){
		//查询产品详情页图片
		List<WechatProductAlbum> list = wechatProductAlbumService.selectWechatProductAlbumByProductId(productId);
		//产品基本信息
		WechatProduct product = wechatProductService.selectWechatProductById(productId);
