...
public class WechatShopProductCategoryServiceImpl implements IWechatShopProductCategoryService 
{
	...
	@Override
	public PageResult queryCategory(PageRequest pageRequest) {
     ...
     * @return
     */
    private PageInfo<WechatShopProductCategory> getPageInfo(PageRequest pageRequest) {
        int pageNum = pageRequest.getPageNum();
        int pageSize = pageRequest.getPageSize();
        PageHelper.startPage(pageNum, pageSize);
        List<WechatShopProductCategory> sysMenus = wechatShopProductCategoryMapper.selectSecondChannelTree();
