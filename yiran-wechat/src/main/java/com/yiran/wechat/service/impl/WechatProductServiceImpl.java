...
import com.yiran.common.utils.PageUtils;
...
public class WechatProductServiceImpl implements IWechatProductService 
{
	...
	@Override
	public PageResult queryGoodsListByCid(PageRequest pageRequest,WechatProduct wechatProduct) {
		return PageUtils.getPageResult(getPageInfo(pageRequest,wechatProduct));
	}
     ...
     * @return
     */
    private PageInfo<WechatProduct> getPageInfo(PageRequest pageRequest,WechatProduct wechatProduct) {
        int pageNum = pageRequest.getPageNum();
        int pageSize = pageRequest.getPageSize();
        PageHelper.startPage(pageNum, pageSize);
        List<WechatProduct> sysMenus = wechatProductMapper.selectWechatProductList(wechatProduct);
